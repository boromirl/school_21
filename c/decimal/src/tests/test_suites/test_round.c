...
static s21_decimal results[] = {
    ...
    {{0x000004D2, 0x00000000, 0x00000000, 0x00000000}},  // 1234
};

START_TEST(test) {
  s21_decimal temp;
  for (size_t i = 0; i < sizeof(input_data) / sizeof(s21_decimal); ++i) {
    s21_round(input_data[i], &temp);
...
Suite *suite_round(void) {
  Suite *suite = suite_create(MAGENTA "[s21_round]" RESET);
  TCase *tcase_core = tcase_create(RED "s21_round_tc" RESET);
