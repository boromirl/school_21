...
// сложение матриц, заполненных одинаковыми положительными числами
START_TEST(s21_sum_matrix_4) {
  ...
  fill_matrix(&A, 3.0);
  fill_matrix(&B, 7.0);
  fill_matrix(&correct_matrix, 10.0);
...
// сложение матриц, заполненных одинаковыми отрицательными числами
START_TEST(s21_sum_matrix_5) {
  ...
  fill_matrix(&correct_matrix, -521.04008);
...
// сложение матриц, заполненных одинаковыми отрицательными/положительными
// числами
START_TEST(s21_sum_matrix_6) {
  ...
  fill_matrix(&correct_matrix, 96054.6);
...
// сложение матриц, заполненных разными числами 1
START_TEST(s21_sum_matrix_7) {
  ...
  A.matrix[0][0] = 3.2, A.matrix[0][1] = -440, A.matrix[0][2] = 8.2,
  A.matrix[0][3] = 17;
  A.matrix[1][0] = 140, A.matrix[1][1] = 8.2, A.matrix[1][2] = -20.45,
  A.matrix[1][3] = 24000;
  A.matrix[2][0] = 81, A.matrix[2][1] = 7.43, A.matrix[2][2] = -0.00001,
  A.matrix[2][3] = 500000;

  B.matrix[0][0] = 17, B.matrix[0][1] = 3, B.matrix[0][2] = 500,
  B.matrix[0][3] = 4.2;
  B.matrix[1][0] = 140, B.matrix[1][1] = -8.2, B.matrix[1][2] = -20.45,
  B.matrix[1][3] = -23000;
  B.matrix[2][0] = 300.14, B.matrix[2][1] = -7.43, B.matrix[2][2] = 0.00001,
  B.matrix[2][3] = 1000000;

  correct_matrix.matrix[0][0] = 20.2, correct_matrix.matrix[0][1] = -437,
  correct_matrix.matrix[0][2] = 508.2, correct_matrix.matrix[0][3] = 21.2;
  correct_matrix.matrix[1][0] = 280, correct_matrix.matrix[1][1] = 0.0,
  correct_matrix.matrix[1][2] = -40.9, correct_matrix.matrix[1][3] = 1000;
  correct_matrix.matrix[2][0] = 381.14, correct_matrix.matrix[2][1] = 0.0,
  correct_matrix.matrix[2][2] = 0.0, correct_matrix.matrix[2][3] = 1500000;
...
// сложение матриц, заполненных разными числами 2
START_TEST(s21_sum_matrix_8) {
  ...
  correct_matrix.matrix[1][0] = 8E20, correct_matrix.matrix[1][1] = 0.0;
...
Suite *suite_sum_matrix(void) {
  Suite *suite = suite_create(MAGENTA "[s21_sum_matrix]" RESET);
  TCase *tcase_core = tcase_create(RED "s21_sum_matrix_tc" RESET);
  ...
  if (suite != NULL && tcase_core != NULL) {
    ...
    tcase_add_test(tcase_core, s21_sum_matrix_9);
    tcase_add_test(tcase_core, s21_sum_matrix_10);
